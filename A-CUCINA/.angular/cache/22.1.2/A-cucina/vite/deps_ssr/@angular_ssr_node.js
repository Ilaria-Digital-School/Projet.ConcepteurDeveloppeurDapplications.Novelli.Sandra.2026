import { C as validateUrl, S as parseForwardedHeader, _ as renderApplication, b as isProxyHeaderAllowed, g as SERVER_CONTEXT, r as InlineCriticalCssProcessor, t as AngularAppEngine, v as renderModule, x as normalizeTrustProxyHeaders, y as getFirstHeaderValue } from "./ssr-BKrgsMcQ.js";
...
async function writeResponseToNodeResponse(source, destination) {
	...
	try {
		...
		while (true) {
			...
			if (destination.write(value) === false) await new Promise((resolve) => destination.once("drain", resolve));
		}
	} catch {
